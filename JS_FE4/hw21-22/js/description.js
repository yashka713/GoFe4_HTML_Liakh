var description= {
    ...
    visual: `ВИЗУАЛЫ— это люди, которые «видят» окружающий мир. У них обычно высокий голос, зоркий взгляд, жесты
    горизонтальны, направлены от себя.При общении визуал смотрит в глаза и требует этого от собеседника. Его принцип:
    "он меня не слушает, потому что не смотрит на меня". Визуалы очень хорошо чувствуют окружающее их
